...
<template>
  ...
  <nav v-if="showNav">
    ...
    <router-link v-if="canViewSeller" to="/seller"><i class="bi bi-calculator"></i></router-link>
    <router-link v-if="canViewSeller" to="/inventory"><i class="bi bi-box-seam"></i></router-link>
    <router-link v-if="canViewNotifications" to="/notifications-history"><i class="bi bi-bell"></i></router-link>
    <router-link v-if="canViewHistory" to="/history"><i class="bi bi-clock-history"></i></router-link>
